...
const CATS = ['all', 'Track', 'Signal', 'OHE']
  ...
  return (
    <div>
      <div className="page-head">
        <div><h2>Assets</h2><p>Track · Signal/S&T · OHE/Traction — inspect before raising requests.</p></div>
      </div>
          ...
          <table className="tbl">
            ...
            <tbody>
              {filtered.slice(0, 300).map((r) => {
                const hot = ['critical', 'poor'].includes(normStatus(pick(r, 'criticality', 'condition')))
                return (
