...
export default function RailwayGIS({
    tasks: propTasks,
    title = "Railway GIS Monitoring",
    subtitle = "South Tamil Nadu Railway Network — Real-time Maintenance Locations",
    role = "admin",
}) {
    ...
    return (
        ...
        >
            ...
            >
                <Stat label="Total Monitored" value={statistics.total} color="#374151" />
